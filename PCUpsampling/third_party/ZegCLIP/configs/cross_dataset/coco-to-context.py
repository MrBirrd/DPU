_base_ = [
    ...
    "../_base_/datasets/context_60_512x512.py",
...
model = dict(
    ...
    ft_backbone=False,
    exclude_key="prompt",
    load_text_embedding="configs/_base_/datasets/text_embedding/context_multi.npy",
)

lr_config = dict(
    policy="poly", power=0.9, min_lr=1e-6, by_epoch=False, warmup="linear", warmup_iters=1500, warmup_ratio=1e-6
)
